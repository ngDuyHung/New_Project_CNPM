...
<table width="100%">
  ...
  <tr style="vertical-align: top;">
    ...
    <td width="50%" style="padding: 10px;">
      <h4 style="color: #0366d6;">💬 Chatbot AI (Đang phát triển)</h4>
...
<details>
  <summary><strong>Nhấn vào đây để xem danh sách đầy đủ 14 thành viên</strong></summary>
...
3.  **🔌 Cài đặt Backend:**
    * Đi đến thư mục `backend`, cài đặt các gói phụ thuộc và khởi động server:
        ```bash
        cd backend
        npm install
        # Tạo file .env với thông tin database của bạn theo mẫu
        # DB_HOST=localhost
...
4.  **🖥️ Cài đặt Frontend:**
    * Mở một terminal mới, đi đến thư mục `frontend`, cài đặt các gói phụ thuộc và khởi động:
        ```bash
        cd frontend
        npm install
        npm start
